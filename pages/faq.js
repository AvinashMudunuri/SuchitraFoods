  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Suchitra Foods FAQ`} />
        <meta property="og:title" content={`FAQ | Suchitra Foods`} />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://www.suchitrafoods.com/faq`}
        />
      </Head>
      <Container maxWidth="md" sx={{ mt: 4 }}>
        <Box>
          ...
          <Typography variant="h6">1. What is www.suchitrafoods.com?</Typography>
          <Typography variant="body1" gutterBottom>
            www.suchitrafoods.com is a website that sells food products. We offer a wide range of high-quality products, including snacks, sweets, and spices, all made with the finest ingredients and traditional recipes.
          </Typography>
