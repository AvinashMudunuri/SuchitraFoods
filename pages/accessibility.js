            ...
            <Container maxWidth="md" sx={{ mt: 4 }}>
                <Box>
                    ...
                    <Typography variant="body1" gutterBottom>
                        At www.suchitraindustries.com, we are committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.
                    </Typography>

                    <Typography variant="h6">2. Accessibility on www.suchitraindustries.com</Typography>
                    <Typography variant="body1" gutterBottom>
                    ...
                    <Typography variant="body1" gutterBottom>
                        The Web Content Accessibility Guidelines (WCAG) define requirements for designers and developers to improve accessibility for people with disabilities. It defines three levels of conformance: Level A, Level AA, and Level AAA. www.suchitraindustries.com is partially conformant with WCAG 2.1 level AA. Partially conformant means that some parts of the content do not fully conform to the accessibility standard.
                    </Typography>

                    <Typography variant="h6">4. Feedback</Typography>
                    <Typography variant="body1" gutterBottom>
                        We welcome your feedback on the accessibility of www.suchitraindustries.com. Please let us know if you encounter accessibility barriers on our website:
                    </Typography>
                    <ul>
                        <li><Typography variant="body1" gutterBottom>Email: <a href="mailto:connect@suchitrafoods.com">connect@suchitrafoods.com</a></Typography></li>
                        <li><Typography variant="body1" gutterBottom>Phone: +91 7331130990</Typography></li>
                    </ul>
                    <Typography variant="body1" gutterBottom>
                        We try to respond to feedback within [Insert number] business days.
                    </Typography>

                    <Typography variant="h6">5. Technical Specifications</Typography>
                    <Typography variant="body1" gutterBottom>
                        Accessibility of www.suchitraindustries.com relies on the following technologies to work with the particular combination of web browser and any assistive technologies or plugins installed on your computer:
                    </Typography>
                    <ul>
                    ...
                    <Typography variant="body1" gutterBottom>
                        www.suchitraindustries.com assesses the accessibility of our website through self-evaluation and continuous monitoring of our digital assets.
                    </Typography>
                    ...
                    <Typography variant="body1" gutterBottom>
                        Despite our best efforts to ensure accessibility of www.suchitraindustries.com, there may be some limitations. Below is a description of known limitations and potential solutions:
                    </Typography>
                    <ul>
                    ...
                    <Typography variant="body1" gutterBottom>Email: <a href="mailto:connect@suchitrafoods.com">connect@suchitrafoods.com</a></Typography>
